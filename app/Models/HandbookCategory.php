...
class HandbookCategory extends Model
{
    ...
    {
        return $this->hasMany(Handbook::class, 'category_id', 'id');
    }

    public function categories(): ?HasMany
    {
        return $this->hasMany(HandbookCategory::class, 'category_id');
    }

    public function childrenCategories(): ?HasMany
    {
        return $this->hasMany(HandbookCategory::class)->with('categories');
    }

@extends('index')
@section('title', __('titles.reports'))
    ...
    <div class="content-wraper">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="">{{ __('titles.reports') }}</li>
            </ol>
        </nav>

        @livewire('sections-tree', ['model' => \App\Models\ReportCategory::class, 'reportsDetail', 'detailModel' => \App\Models\Report::class, 'detailModelRedaction' => \App\Models\ReportRedaction::class])
    </div>
@endsection

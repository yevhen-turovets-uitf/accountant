@extends('index')
@section('title', __('titles.blanks'))
    ...
    <div class="content-wraper">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="">{{ __('titles.blanks') }}</li>
            </ol>
        </nav>

        @livewire('sections-tree', ['model' => \App\Models\BlankCategory::class, 'blanksDetail', 'detailModel' => \App\Models\Blank::class, 'detailModelRedaction' => \App\Models\BlankRedaction::class])
    </div>
@endsection
